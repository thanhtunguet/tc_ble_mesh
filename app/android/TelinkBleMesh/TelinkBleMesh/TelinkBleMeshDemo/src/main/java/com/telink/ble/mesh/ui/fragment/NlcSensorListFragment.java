/********************************************************************************************************
 * @file NlcSensorListFragment.java
 *
 ...
 */
public class NlcSensorListFragment extends BaseFragment {
    ...
    private void initView(View view) {
        List<NodeInfo> nodeList = getSensors();
        if (nodeList.size() != 0) {
    ...
    private List<NodeInfo> getSensors() {
