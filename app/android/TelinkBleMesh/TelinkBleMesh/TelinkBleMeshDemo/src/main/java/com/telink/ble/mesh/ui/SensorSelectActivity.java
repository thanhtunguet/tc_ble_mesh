...
import com.telink.ble.mesh.ui.adapter.SensorSelectAdapter;
 ...
 * select sensor(s)
 */
public class SensorSelectActivity extends BaseActivity implements View.OnClickListener,
        BaseSelectableListAdapter.SelectStatusChangedListener,
        EventListener<String> {

    public static final String EXTRA_SELECTED_SENSORS = "EXTRA_SELECTED_SENSORS";

    private SensorSelectAdapter deviceSelectAdapter;
    ...
    private void initView() {
        ...
        deviceSelectAdapter = new SensorSelectAdapter(this, nodes);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_confirm:
                ...
                intent.putIntegerArrayListExtra(EXTRA_SELECTED_SENSORS, nodes);
